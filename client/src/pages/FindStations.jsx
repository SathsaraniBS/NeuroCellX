    ...
    <div className="min-h-screen bg-gray-50 font-sans flex flex-col">
      ...
      <nav className="bg-white border-b px-6 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-2 text-xl font-bold text-gray-800">
          ...
          <span>Volt<span className="text-emerald-500">IQ</span></span>
        </div>
        <div className="hidden md:flex space-x-8 text-sm font-medium text-gray-500">
          <a href="#" className="hover:text-gray-900">Dashboard</a>
          <a href="#" className="text-blue-600 border-b-2 border-blue-600 pb-1">Charging</a>
          <a href="#" className="hover:text-gray-900">Battery</a>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="w-8 h-8 bg-gray-300 rounded-full overflow-hidden border-2 border-emerald-500">
